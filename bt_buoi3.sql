...
('Guest1','guest@gmail.com',123),
('Guest2','guest2@gmail.com',456),
('Guest3','guest3@gmail.com',789)

INSERT INTO food ( food_name, img, price, description) VALUES
('Cơm gà','http:hinhComGa.png',25000,'Ăn rất ngon'),
('Bún bò','http:hinhBunBo.png',25000,'Ăn quên lối về'),
('Sủi cảo','http:hinhSuiCao.png',60000,'Ăn trông rất sang')
